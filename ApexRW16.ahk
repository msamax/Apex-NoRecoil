...
; Script version ReWrite V 2 S16 Update
...
Global Supplydrop_Weapon = 0x312E90 ; Normal
	...
	Else If (AmmoType == Energy_Weapon) {
		If (Check_Weapon(Lstar_PIXELS)) {
			...
			Return Volt_Weapon
                  ...
                  Else If (Check_Weapon(nemesis_PIXELS)) {
			Global RapidMode := 0
...
HideProcess() {
    ...
    MsgBox, % "进程 ('" . A_ScriptName . "') 隐藏! `nYour uuid is " UUID
    return
}
